...
namespace SeaWar.Mathematics
{
    ...
    public partial struct uint4 : System.IEquatable<uint4>, IFormattable
    {
        ...
        /// <summary>Constructs a uint4 vector from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint4(Single v)
        {
            this.x = (uint)v;
            this.y = (uint)v;
            this.z = (uint)v;
        ...
        /// <summary>Explicitly converts a single Single value to a uint4 vector by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint4(Single v) { return new uint4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint4 vector constructed from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint4 uint4(Single v) { return new uint4(v); }
