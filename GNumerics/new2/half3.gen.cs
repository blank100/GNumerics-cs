...
namespace SeaWar.Mathematics
{
    ...
    public partial struct half3 : System.IEquatable<half3>, IFormattable
    {
        ...
        /// <summary>Constructs a half3 vector from a single Single value by converting it to half and assigning it to every component.</summary>
        /// <param name="v">Single to convert to half3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public half3(Single v)
        {
            this.x = (half)v;
            this.y = (half)v;
            this.z = (half)v;
        ...
        /// <summary>Explicitly converts a single Single value to a half3 vector by converting it to half and assigning it to every component.</summary>
        /// <param name="v">Single to convert to half3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator half3(Single v) { return new half3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a half3 vector constructed from a single Single value by converting it to half and assigning it to every component.</summary>
        /// <param name="v">Single to convert to half3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static half3 half3(Single v) { return new half3(v); }
