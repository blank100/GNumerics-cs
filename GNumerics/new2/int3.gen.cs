...
namespace SeaWar.Mathematics
{
    ...
    public partial struct int3 : System.IEquatable<int3>, IFormattable
    {
        ...
        /// <summary>Constructs a int3 vector from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int3(Single v)
        {
            this.x = (int)v;
            this.y = (int)v;
            this.z = (int)v;
        ...
        /// <summary>Explicitly converts a single Single value to a int3 vector by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int3(Single v) { return new int3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int3 vector constructed from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3 int3(Single v) { return new int3(v); }
