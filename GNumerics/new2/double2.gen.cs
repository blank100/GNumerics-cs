...
namespace SeaWar.Mathematics
{
    ...
    public partial struct double2 : System.IEquatable<double2>, IFormattable
    {
        ...
        /// <summary>Constructs a double2 vector from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double2(Single v)
        {
            this.x = v;
            this.y = v;
        }
        ...
        /// <summary>Implicitly converts a single Single value to a double2 vector by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2(Single v) { return new double2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double2 vector constructed from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2 double2(Single v) { return new double2(v); }
