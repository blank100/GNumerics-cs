...
namespace SeaWar.Mathematics
{
    ...
    public partial struct int2x4 : System.IEquatable<int2x4>, IFormattable
    {
        ...
        /// <summary>Constructs a int2x4 matrix from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int2x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int2x4(Single v)
        {
            this.c0 = (int2)v;
            this.c1 = (int2)v;
            this.c2 = (int2)v;
        ...
        /// <summary>Explicitly converts a single Single value to a int2x4 matrix by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int2x4(Single v) { return new int2x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int2x4 matrix constructed from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2x4 int2x4(Single v) { return new int2x4(v); }
