...
namespace SeaWar.Mathematics
{
    ...
    public partial struct uint3x3 : System.IEquatable<uint3x3>, IFormattable
    {
        ...
        /// <summary>Constructs a uint3x3 matrix from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint3x3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint3x3(Single v)
        {
            this.c0 = (uint3)v;
            this.c1 = (uint3)v;
            this.c2 = (uint3)v;
        ...
        /// <summary>Explicitly converts a single Single value to a uint3x3 matrix by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint3x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3x3(Single v) { return new uint3x3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint3x3 matrix constructed from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint3x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint3x3 uint3x3(Single v) { return new uint3x3(v); }
