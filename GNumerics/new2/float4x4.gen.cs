...
namespace SeaWar.Mathematics
{
    ...
    public partial struct float4x4 : System.IEquatable<float4x4>, IFormattable
    {
        ...
        /// <summary>Constructs a float4x4 matrix from 16 Single values given in row-major order.</summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float4x4(Single m00, Single m01, Single m02, Single m03,
        ...
        /// <summary>Constructs a float4x4 matrix from a single Single value by assigning it to every component.</summary>
        /// <param name="v">Single to convert to float4x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float4x4(Single v)
        {
            this.c0 = v;
            this.c1 = v;
            this.c2 = v;
        ...
        /// <summary>Constructs a float4x4 matrix from a single bool value by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">bool to convert to float4x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float4x4(bool v)
        {
            this.c0 = math.select(new float4(0), new float4(1), v);
            this.c1 = math.select(new float4(0), new float4(1), v);
            this.c2 = math.select(new float4(0), new float4(1), v);
            this.c3 = math.select(new float4(0), new float4(1), v);
        }
        ...
        {
            this.c0 = math.select(new float4(0), new float4(1), v.c0);
            this.c1 = math.select(new float4(0), new float4(1), v.c1);
            this.c2 = math.select(new float4(0), new float4(1), v.c2);
            this.c3 = math.select(new float4(0), new float4(1), v.c3);
        }

        /// <summary>Constructs a float4x4 matrix from a single int value by converting it to Single and assigning it to every component.</summary>
        ...
        /// <summary>Constructs a float4x4 matrix from a single uint value by converting it to Single and assigning it to every component.</summary>
        ...
        /// <summary>Constructs a float4x4 matrix from a single Double value by converting it to Single and assigning it to every component.</summary>
        ...
        /// <summary>Implicitly converts a single Single value to a float4x4 matrix by assigning it to every component.</summary>
        /// <param name="v">Single to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator float4x4(Single v) { return new float4x4(v); }

        /// <summary>Explicitly converts a single bool value to a float4x4 matrix by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">bool to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Implicitly converts a single int value to a float4x4 matrix by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">int to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Implicitly converts a single uint value to a float4x4 matrix by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">uint to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Explicitly converts a single Double value to a float4x4 matrix by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">Double to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns the result of a componentwise multiplication operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise multiplication.</param>
        /// <param name="rhs">Right hand side Single to use to compute componentwise multiplication.</param>
        /// <returns>float4x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 operator * (float4x4 lhs, Single rhs) { return new float4x4 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs, lhs.c3 * rhs); }

        /// <summary>Returns the result of a componentwise multiplication operation on a Single value and a float4x4 matrix.</summary>
        /// <param name="lhs">Left hand side Single to use to compute componentwise multiplication.</param>
        /// <param name="rhs">Right hand side float4x4 to use to compute componentwise multiplication.</param>
        /// <returns>float4x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 operator * (Single lhs, float4x4 rhs) { return new float4x4 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2, lhs * rhs.c3); }
        ...
        /// <summary>Returns the result of a componentwise addition operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise addition.</param>
        ...
        /// <summary>Returns the result of a componentwise addition operation on a Single value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise subtraction operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise subtraction.</param>
        ...
        /// <summary>Returns the result of a componentwise subtraction operation on a Single value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise division operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise division.</param>
        ...
        /// <summary>Returns the result of a componentwise division operation on a Single value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise modulus operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise modulus.</param>
        ...
        /// <summary>Returns the result of a componentwise modulus operation on a Single value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise less than operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise less than.</param>
        /// <param name="rhs">Right hand side Single to use to compute componentwise less than.</param>
        /// <returns>bool4x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4x4 operator < (float4x4 lhs, Single rhs) { return new bool4x4 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs, lhs.c3 < rhs); }

        /// <summary>Returns the result of a componentwise less than operation on a Single value and a float4x4 matrix.</summary>
        /// <param name="lhs">Left hand side Single to use to compute componentwise less than.</param>
        /// <param name="rhs">Right hand side float4x4 to use to compute componentwise less than.</param>
        /// <returns>bool4x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4x4 operator < (Single lhs, float4x4 rhs) { return new bool4x4 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2, lhs < rhs.c3); }
        ...
        /// <summary>Returns the result of a componentwise less or equal operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise less or equal.</param>
        ...
        /// <summary>Returns the result of a componentwise less or equal operation on a Single value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise greater than operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise greater than.</param>
        ...
        /// <summary>Returns the result of a componentwise greater than operation on a Single value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise greater or equal operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise greater or equal.</param>
        ...
        /// <summary>Returns the result of a componentwise greater or equal operation on a Single value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise equality operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise equality.</param>
        ...
        /// <summary>Returns the result of a componentwise equality operation on a Single value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise not equal operation on a float4x4 matrix and a Single value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise not equal.</param>
        ...
        /// <summary>Returns the result of a componentwise not equal operation on a Single value and a float4x4 matrix.</summary>
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a float4x4 matrix constructed from from 16 Single values given in row-major order.</summary>
        /// <param name="m00">The matrix at row 0, column 0 will be set to this value.</param>
        /// <param name="m01">The matrix at row 0, column 1 will be set to this value.</param>
        /// <param name="m02">The matrix at row 0, column 2 will be set to this value.</param>
        /// <param name="m03">The matrix at row 0, column 3 will be set to this value.</param>
        ...
        /// <returns>float4x4 constructed from arguments.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 float4x4(Single m00, Single m01, Single m02, Single m03,
                                        Single m10, Single m11, Single m12, Single m13,
                                        Single m20, Single m21, Single m22, Single m23,
                                        Single m30, Single m31, Single m32, Single m33)
        {
        ...
        /// <summary>Returns a float4x4 matrix constructed from a single Single value by assigning it to every component.</summary>
        /// <param name="v">Single to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 float4x4(Single v) { return new float4x4(v); }

        /// <summary>Returns a float4x4 matrix constructed from a single bool value by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">bool to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a float4x4 matrix constructed from a single int value by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">int to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a float4x4 matrix constructed from a single uint value by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">uint to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a float4x4 matrix constructed from a single Double value by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">Double to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        public static float4x4 inverse(float4x4 m)
        {
            ...
            float4 rcp_denom_ppnn = float4(1) / denom;
            float4x4 res;
        ...
        public static Single determinant(float4x4 m)
        {
            float4 c0 = m.c0;
            float4 c1 = m.c1;
            float4 c2 = m.c2;
            ...
            Single m00 = c1.y * (c2.z * c3.w - c2.w * c3.z) - c2.y * (c1.z * c3.w - c1.w * c3.z) + c3.y * (c1.z * c2.w - c1.w * c2.z);
            Single m01 = c0.y * (c2.z * c3.w - c2.w * c3.z) - c2.y * (c0.z * c3.w - c0.w * c3.z) + c3.y * (c0.z * c2.w - c0.w * c2.z);
            Single m02 = c0.y * (c1.z * c3.w - c1.w * c3.z) - c1.y * (c0.z * c3.w - c0.w * c3.z) + c3.y * (c0.z * c1.w - c0.w * c1.z);
            Single m03 = c0.y * (c1.z * c2.w - c1.w * c2.z) - c1.y * (c0.z * c2.w - c0.w * c2.z) + c2.y * (c0.z * c1.w - c0.w * c1.z);
