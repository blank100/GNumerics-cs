...
namespace SeaWar.Mathematics
{
    ...
    public partial struct int3x2 : System.IEquatable<int3x2>, IFormattable
    {
        ...
        /// <summary>Constructs a int3x2 matrix from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int3x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int3x2(Single v)
        {
            this.c0 = (int3)v;
            this.c1 = (int3)v;
        }
        ...
        /// <summary>Explicitly converts a single Single value to a int3x2 matrix by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int3x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int3x2(Single v) { return new int3x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int3x2 matrix constructed from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int3x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3x2 int3x2(Single v) { return new int3x2(v); }
