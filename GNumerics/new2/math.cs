namespace SeaWar.Mathematics
{
    ...
    public static partial class math
    {
        ...
        /// <summary>
        /// The difference between 1 and the next representable f64/Double precision number.
        ///
        /// Beware:
        /// This value is different from Double.Epsilon, which is the smallest, positive, denormalized f64/Double.
        /// </summary>
        ...
        /// <summary>The smallest positive normal number representable in a Single.</summary>
        public const Single FLT_MIN_NORMAL = 1.175494351e-38F;
        ...
        public const Single E = (Single)E_DBL;

        /// <summary>The base 2 logarithm of e. Approximately 1.44.</summary>
        public const Single LOG2E = (Single)LOG2E_DBL;

        /// <summary>The base 10 logarithm of e. Approximately 0.43.</summary>
        public const Single LOG10E = (Single)LOG10E_DBL;

        /// <summary>The natural logarithm of 2. Approximately 0.69.</summary>
        public const Single LN2 = (Single)LN2_DBL;

        /// <summary>The natural logarithm of 10. Approximately 2.30.</summary>
        public const Single LN10 = (Single)LN10_DBL;

        /// <summary>The mathematical constant pi. Approximately 3.14.</summary>
        public const Single PI = (Single)PI_DBL;

        /// <summary>The square root 2. Approximately 1.41.</summary>
        public const Single SQRT2 = (Single)SQRT2_DBL;

        /// <summary>
        /// The difference between 1 and the next representable f32/single precision number.
        ///
        /// Beware:
        /// This value is different from Single.Epsilon, which is the smallest, positive, denormalized f32/single.
        /// </summary>
        public const Single EPSILON = 1.1920928955078125e-7f;
        ...
        /// is NAN, use isnan().
        /// </summary>
        public const Single NAN = Single.NaN;
        ...
        /// <summary>Returns the bit pattern of a Single as an int.</summary>
        /// <param name="x">The Single bits to copy.</param>
        /// <returns>The int with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int asint(Single x) {
            IntFloatUnion u;
            u.intValue = 0;
            u.floatValue = x;
            return u.intValue;
        ...
        /// <summary>Returns the bit pattern of a Single as a uint.</summary>
        /// <param name="x">The Single bits to copy.</param>
        /// <returns>The uint with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint asuint(Single x) { return (uint)asint(x); }
        ...
        /// <summary>Returns the bit pattern of an int as a Single.</summary>
        /// <param name="x">The int bits to copy.</param>
        /// <returns>The Single with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single asfloat(int x)
        {
            IntFloatUnion u;
            u.floatValue = 0;
            u.intValue = x;
        ...
        /// <summary>Returns the bit pattern of a uint as a Single.</summary>
        /// <param name="x">The uint bits to copy.</param>
        /// <returns>The Single with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single  asfloat(uint x) { return asfloat((int)x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool isnan(Single x) { return (asuint(x) & 0x7FFFFFFF) > 0x7F800000; }
        ...
        /// <summary>Returns the minimum of two Single values.</summary>
        /// <param name="x">The first input value.</param>
        /// <param name="y">The second input value.</param>
        /// <returns>The minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns the maximum of two Single values.</summary>
        /// <param name="x">The first input value.</param>
        /// <param name="y">The second input value.</param>
        /// <returns>The maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single lerp(Single x, Single y, Single s) { return x + s * (y - x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2 lerp(float2 x, float2 y, Single s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3 lerp(float3 x, float3 y, Single s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4 lerp(float4 x, float4 y, Single s) { return x + s * (y - x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single unlerp(Single a, Single b, Single x) { return (x - a) / (b - a); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single remap(Single a, Single b, Single c, Single d, Single x) { return lerp(c, d, unlerp(a, b, x)); }
        ...
        /// <summary>Returns the result of a multiply-add operation (a * b + c) on 3 Single values.</summary>
        /// <remarks>
        ...
        /// <returns>The multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single mad(Single a, Single b, Single c) { return a * b + c; }
        ...
        /// <summary>Returns the result of clamping the value x into the interval [a, b], where x, a and b are Single values.</summary>
        /// <param name="x">Input value to be clamped.</param>
        /// <param name="a">Lower bound of the interval.</param>
        /// <param name="b">Upper bound of the interval.</param>
        /// <returns>The clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single clamp(Single x, Single a, Single b) { return max(a, min(b, x)); }
        ...
        /// <summary>Returns the result of clamping the Single value x into the interval [0, 1].</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The clamping of the input into the interval [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single saturate(Single x) { return clamp(x, 0, 1); }
        ...
        /// <summary>Returns the absolute value of a Single value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The absolute value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single abs(Single x) { return asfloat(asuint(x) & 0x7FFFFFFF); }
        ...
        /// <summary>Returns the dot product of two Single values. Equivalent to multiplication.</summary>
        /// <param name="x">The first value.</param>
        /// <param name="y">The second value.</param>
        /// <returns>The dot product of two values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single dot(Single x, Single y) { return x * y; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single dot(float2 x, float2 y) { return x.x * y.x + x.y * y.y; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single dot(float3 x, float3 y) { return x.x * y.x + x.y * y.y + x.z * y.z; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single dot(float4 x, float4 y) { return x.x * y.x + x.y * y.y + x.z * y.z + x.w * y.w; }
        ...
        /// <summary>Returns the tangent of a Single value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single tan(Single x) { return (Single)Math.Tan(x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single atan(Single x) { return (Single)Math.Atan(x); }
        ...
        /// <summary>Returns the 2-argument arctangent of a pair of Single values.</summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single atan2(Single y, Single x) { return (Single)Math.Atan2(y, x); }
        ...
        /// <summary>Returns the cosine of a Single value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The cosine cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single cos(Single x) { return (Single)Math.Cos(x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single acos(Single x) { return (Single)Math.Acos((Single)x); }
        ...
        /// <summary>Returns the sine of a Single value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single sin(Single x) { return (Single)Math.Sin((Single)x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single asin(Single x) { return (Single)Math.Asin((Single)x); }
        ...
        /// <summary>Returns the result of rounding a Single value up to the nearest integral value less or equal to the original value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The round down to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single floor(Single x) { return (Single)Math.Floor((Single)x); }
        ...
        /// <summary>Returns the result of rounding a Single value up to the nearest integral value greater or equal to the original value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The round up to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single ceil(Single x) { return (Single)Math.Ceiling((Single)x); }
        ...
        /// <summary>Returns the result of rounding a Single value to the nearest integral value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The round to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single round(Single x) { return (Single)Math.Round((Single)x); }
        ...
        /// <summary>Returns the result of truncating a Single value to an integral Single value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The truncation of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single trunc(Single x) { return (Single)Math.Truncate((Single)x); }
        ...
        /// <summary>Returns the fractional part of a Single value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The fractional part of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single frac(Single x) { return x - floor(x); }
        ...
        /// <summary>Returns the reciprocal a Single value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The reciprocal of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single rcp(Single x) { return 1 / x; }
        ...
        /// <returns>The reciprocal of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double rcp(Double x) { return 1 / x; }

        /// <summary>Returns the componentwise reciprocal a double2 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise reciprocal of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2 rcp(double2 x) { return 1 / x; }

        /// <summary>Returns the componentwise reciprocal a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise reciprocal of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3 rcp(double3 x) { return 1 / x; }

        /// <summary>Returns the componentwise reciprocal a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise reciprocal of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4 rcp(double4 x) { return 1 / x; }

        /// <summary>Returns the sign of a Single value. -1 if it is less than zero, 0 if it is zero and 1 if it greater than zero.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single sign(Single x) { return (x > 0 ? 1 : 0) - (x < 0 ? 1 : 0); }

        /// <summary>Returns the componentwise sign of a float2 value. 1 for positive components, 0 for zero components and -1 for negative components.</summary>
        /// <param name="x">Input value.</param>
        ...
        /// <summary>Returns the componentwise sign of a float3 value. 1 for positive components, 0 for zero components and -1 for negative components.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3 sign(float3 x) { return new float3(sign(x.x), sign(x.y), sign(x.z)); }

        /// <summary>Returns the componentwise sign of a float4 value. 1 for positive components, 0 for zero components and -1 for negative components.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns the sign of a Double value. -1 if it is less than zero, 0 if it is zero and 1 if it greater than zero.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double sign(Double x) { return x == 0 ? 0 : (x > 0 ? 1 : 0) - (x < 0 ? 1 : 0); }

        /// <summary>Returns the componentwise sign of a double2 value. 1 for positive components, 0 for zero components and -1 for negative components.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2 sign(double2 x) { return new double2(sign(x.x), sign(x.y)); }

        /// <summary>Returns the componentwise sign of a double3 value. 1 for positive components, 0 for zero components and -1 for negative components.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3 sign(double3 x) { return new double3(sign(x.x), sign(x.y), sign(x.z)); }

        /// <summary>Returns the componentwise sign of a double4 value. 1 for positive components, 0 for zero components and -1 for negative components.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single pow(Single x, Single y) { return (Single)Math.Pow((Single)x, (Single)y); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single exp(Single x) { return (Single)Math.Exp((Single)x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single exp2(Single x) { return (Single)Math.Exp((Single)x * 0.69314718f); }
        ...
        /// <returns>The base-2 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double exp2(Double x) { return Math.Exp(x * 0.693147180559945309); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single exp10(Single x) { return (Single)Math.Exp((Single)x * 2.30258509f); }
        ...
        /// <returns>The base-10 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double exp10(Double x) { return Math.Exp(x * 2.302585092994045684); }
        ...
        /// <summary>Returns the natural logarithm of a Single value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The natural logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single log(Single x) { return (Single)Math.Log((Single)x); }
        ...
        /// <summary>Returns the base-2 logarithm of a Single value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The base-2 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single log2(Single x) { return (Single)Math.Log((Single)x, 2); }
        ...
        /// <returns>The base-2 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double log2(Double x) { return Math.Log(x, 2.0); }
        ...
        /// <summary>Returns the base-10 logarithm of a Single value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The base-10 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single log10(Single x) { return (Single)Math.Log10((Single)x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single fmod(Single x, Single y) { return x % y; }
        ...
        /// <summary>Splits a Single value into an integral part i and a fractional part that gets returned. Both parts take the sign of the input.</summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single modf(Single x, out Single i) { i = trunc(x); return x - i; }
        ...
        /// <summary>Returns the square root of a Single value.</summary>
        /// <param name="x">Value to use when computing square root.</param>
        /// <returns>The square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single sqrt(Single x) { return (Single)Math.Sqrt((Single)x); }
        ...
        /// <summary>Returns the reciprocal square root of a Single value.</summary>
        /// <param name="x">Value to use when computing reciprocal square root.</param>
        /// <returns>The reciprocal square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single rsqrt(Single x) { return 1 / sqrt(x); }
        ...
        /// <summary>Returns the length of a Single value. Equivalent to the absolute value.</summary>
        /// <param name="x">Value to use when computing length.</param>
        /// <returns>Length of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single length(Single x) { return abs(x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single length(float2 x) { return sqrt(dot(x, x)); }

        /// <summary>Returns the length of a float3 vector.</summary>
        /// <param name="x">Vector to use when computing length.</param>
        /// <returns>Length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single length(float3 x) { return sqrt(dot(x, x)); }

        /// <summary>Returns the length of a float4 vector.</summary>
        /// <param name="x">Vector to use when computing length.</param>
        /// <returns>Length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single length(float4 x) { return sqrt(dot(x, x)); }
        ...
        /// <summary>Returns the squared length of a Single value. Equivalent to squaring the value.</summary>
        /// <param name="x">Value to use when computing squared length.</param>
        /// <returns>Squared length of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single lengthsq(Single x) { return x*x; }

        /// <summary>Returns the squared length of a float2 vector.</summary>
        /// <param name="x">Vector to use when computing squared length.</param>
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single lengthsq(float2 x) { return dot(x, x); }

        /// <summary>Returns the squared length of a float3 vector.</summary>
        /// <param name="x">Vector to use when computing squared length.</param>
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single lengthsq(float3 x) { return dot(x, x); }

        /// <summary>Returns the squared length of a float4 vector.</summary>
        /// <param name="x">Vector to use when computing squared length.</param>
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single lengthsq(float4 x) { return dot(x, x); }
        ...
        /// <summary>Returns the distance between two Single values.</summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single distance(Single x, Single y) { return abs(y - x); }
        ...
        /// <returns>The distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single distance(float2 x, float2 y) { return length(y - x); }
        ...
        /// <returns>The distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single distance(float3 x, float3 y) { return length(y - x); }
        ...
        /// <returns>The distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single distance(float4 x, float4 y) { return length(y - x); }
        ...
        /// <summary>Returns the squared distance between two Single values.</summary>
        /// <param name="x">First value to use in distance computation.</param>
        /// <param name="y">Second value to use in distance computation.</param>
        /// <returns>The squared distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single distancesq(Single x, Single y) { return (y - x) * (y - x); }
        ...
        /// <returns>The squared distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single distancesq(float2 x, float2 y) { return lengthsq(y - x); }
        ...
        /// <returns>The squared distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single distancesq(float3 x, float3 y) { return lengthsq(y - x); }
        ...
        /// <returns>The squared distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single distancesq(float4 x, float4 y) { return lengthsq(y - x); }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single select(Single a, Single b, bool c)    { return c ? b : a; }
        ...
        /// <summary>Returns the result of a step function where the result is 1 when x &gt;= y and 0 otherwise.</summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single step(Single y, Single x) { return select(0, 1, x >= y); }
        ...
        /// <returns>1 if the comparison x &gt;= y is true, otherwise 0.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double step(Double y, Double x) { return select(0, 1, x >= y); }
        ...
        /// <returns>1 if the componentwise comparison x &gt;= y is true, otherwise 0.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2 step(double2 y, double2 x) { return select(double2(0), double2(1), x >= y); }
        ...
        /// <returns>1 if the componentwise comparison x &gt;= y is true, otherwise 0.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3 step(double3 y, double3 x) { return select(double3(0), double3(1), x >= y); }
        ...
        /// <returns>1 if the componentwise comparison x &gt;= y is true, otherwise 0.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4 step(double4 y, double4 x) { return select(double4(0), double4(1), x >= y); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2 refract(float2 i, float2 n, Single eta)
        {
            Single ni = dot(n, i);
            Single k = 1 - eta * eta * (1 - ni * ni);
            return select(0, eta * i - (eta * ni + sqrt(k)) * n, k >= 0);
        }
        ...
        /// <returns>Refraction vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3 refract(float3 i, float3 n, Single eta)
        {
            Single ni = dot(n, i);
            Single k = 1 - eta * eta * (1 - ni * ni);
            return select(0, eta * i - (eta * ni + sqrt(k)) * n, k >= 0);
        ...
        /// <returns>Refraction vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4 refract(float4 i, float4 n, Single eta)
        {
            Single ni = dot(n, i);
            Single k = 1 - eta * eta * (1 - ni * ni);
            return select(0, eta * i - (eta * ni + sqrt(k)) * n, k >= 0);
        ...
        /// In these cases, you can call <see cref="projectsafe(Mathematics.float2,Mathematics.float2,Mathematics.float2)"/>
        ...
        /// Some finite vectors a and b could generate a non-finite result. This is most likely when a's components
        /// are very large (close to Single.MaxValue) or when b's components are very small (close to FLT_MIN_NORMAL).
        /// In these cases, you can call <see cref="projectsafe(Mathematics.float3,Mathematics.float3,Mathematics.float3)"/>
        /// which will use a given default value if the result is not finite.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// Some finite vectors a and b could generate a non-finite result. This is most likely when a's components
        /// are very large (close to Single.MaxValue) or when b's components are very small (close to FLT_MIN_NORMAL).
        /// In these cases, you can call <see cref="projectsafe(Mathematics.float4,Mathematics.float4,Mathematics.float4)"/>
        /// which will use a given default value if the result is not finite.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// <see cref="project(Mathematics.float2,Mathematics.float2)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// This function performs extra checks to see if the result of projecting a onto b is finite. If you know that
        /// your inputs will generate a finite result or you don't care if the result is finite, then you can call
        /// <see cref="project(Mathematics.float3,Mathematics.float3)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// This function performs extra checks to see if the result of projecting a onto b is finite. If you know that
        /// your inputs will generate a finite result or you don't care if the result is finite, then you can call
        /// <see cref="project(Mathematics.float4,Mathematics.float4)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// In these cases, you can call <see cref="projectsafe(Mathematics.double2,Mathematics.double2,Mathematics.double2)"/>
        /// which will use a given default value if the result is not finite.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// Some finite vectors a and b could generate a non-finite result. This is most likely when a's components
        /// are very large (close to Double.MaxValue) or when b's components are very small (close to DBL_MIN_NORMAL).
        /// In these cases, you can call <see cref="projectsafe(Mathematics.double3,Mathematics.double3,Mathematics.double3)"/>
        /// which will use a given default value if the result is not finite.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// Some finite vectors a and b could generate a non-finite result. This is most likely when a's components
        /// are very large (close to Double.MaxValue) or when b's components are very small (close to DBL_MIN_NORMAL).
        /// In these cases, you can call <see cref="projectsafe(Mathematics.double4,Mathematics.double4,Mathematics.double4)"/>
        /// which will use a given default value if the result is not finite.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// This function performs extra checks to see if the result of projecting a onto b is finite. If you know that
        /// your inputs will generate a finite result or you don't care if the result is finite, then you can call
        /// <see cref="project(Mathematics.double2,Mathematics.double2)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// This function performs extra checks to see if the result of projecting a onto b is finite. If you know that
        /// your inputs will generate a finite result or you don't care if the result is finite, then you can call
        /// <see cref="project(Mathematics.double3,Mathematics.double3)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// This function performs extra checks to see if the result of projecting a onto b is finite. If you know that
        /// your inputs will generate a finite result or you don't care if the result is finite, then you can call
        /// <see cref="project(Mathematics.double4,Mathematics.double4)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// <summary>Returns the sine and cosine of the input Single value x through the out parameters s and c.</summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sincos(Single x, out Single s, out Single c) { s = sin(x); c = cos(x); }
        ...
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single cmin(float2 x) { return min(x.x, x.y); }

        /// <summary>Returns the minimum component of a float3 vector.</summary>
        /// <param name="x">The vector to use when computing the minimum component.</param>
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single cmin(float3 x) { return min(min(x.x, x.y), x.z); }

        /// <summary>Returns the minimum component of a float4 vector.</summary>
        /// <param name="x">The vector to use when computing the minimum component.</param>
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single cmin(float4 x) { return min(min(x.x, x.y), min(x.z, x.w)); }
        ...
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single cmax(float2 x) { return max(x.x, x.y); }

        /// <summary>Returns the maximum component of a float3 vector.</summary>
        /// <param name="x">The vector to use when computing the maximum component.</param>
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single cmax(float3 x) { return max(max(x.x, x.y), x.z); }

        /// <summary>Returns the maximum component of a float4 vector.</summary>
        /// <param name="x">The vector to use when computing the maximum component.</param>
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single cmax(float4 x) { return max(max(x.x, x.y), max(x.z, x.w)); }
        ...
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single csum(float2 x) { return x.x + x.y; }

        /// <summary>Returns the horizontal sum of components of a float3 vector.</summary>
        /// <param name="x">The vector to use when computing the horizontal sum.</param>
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single csum(float3 x) { return x.x + x.y + x.z; }

        /// <summary>Returns the horizontal sum of components of a float4 vector.</summary>
        /// <param name="x">The vector to use when computing the horizontal sum.</param>
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single csum(float4 x) { return (x.x + x.y) + (x.z + x.w); }
        ...
        /// <returns>Index to element after the last one stored.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int compress(Single* output, int index, float4 val, bool4 mask)
        {
            return compress((int*)output, index, *(int4*)&val, mask);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3 up() { return new float3(0, 1, 0); }  // for compatibility
