...
namespace SeaWar.Mathematics
{
    ...
    public partial struct int4x2 : System.IEquatable<int4x2>, IFormattable
    {
        ...
        /// <summary>Constructs a int4x2 matrix from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int4x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int4x2(Single v)
        {
            this.c0 = (int4)v;
            this.c1 = (int4)v;
        }
        ...
        /// <summary>Explicitly converts a single Single value to a int4x2 matrix by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int4x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int4x2(Single v) { return new int4x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int4x2 matrix constructed from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int4x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int4x2 int4x2(Single v) { return new int4x2(v); }
