...
namespace SeaWar.Mathematics
{
    ...
    public partial struct double3x2 : System.IEquatable<double3x2>, IFormattable
    {
        ...
        /// <summary>Constructs a double3x2 matrix from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double3x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double3x2(Single v)
        {
            this.c0 = v;
            this.c1 = v;
        }
        ...
        /// <summary>Implicitly converts a single Single value to a double3x2 matrix by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double3x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double3x2(Single v) { return new double3x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double3x2 matrix constructed from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double3x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3x2 double3x2(Single v) { return new double3x2(v); }
