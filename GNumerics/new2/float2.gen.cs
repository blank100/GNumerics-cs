...
namespace SeaWar.Mathematics
{
    ...
    {
        /// <summary>Returns a float2 vector constructed from two Single values.</summary>
        /// <param name="x">The constructed vector's x component will be set to this value.</param>
        /// <param name="y">The constructed vector's y component will be set to this value.</param>
        /// <returns>float2 constructed from arguments.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2 float2(Single x, Single y) { return new float2(x, y); }
        ...
        /// <summary>Returns a float2 vector constructed from a single Single value by assigning it to every component.</summary>
        /// <param name="v">Single to convert to float2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2 float2(Single v) { return new float2(v); }

        /// <summary>Returns a float2 vector constructed from a single bool value by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">bool to convert to float2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a float2 vector constructed from a single int value by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">int to convert to float2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a float2 vector constructed from a single uint value by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">uint to convert to float2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a float2 vector constructed from a single half value by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">half to convert to float2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a float2 vector constructed from a single Double value by converting it to Single and assigning it to every component.</summary>
        /// <param name="v">Double to convert to float2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns the result of specified shuffling of the components from two float2 vectors into a Single value.</summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single shuffle(float2 left, float2 right, ShuffleComponent x)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Single select_shuffle_component(float2 a, float2 b, ShuffleComponent component)
        {
            switch(component)
            {
