...
namespace SeaWar.Mathematics
{
    ...
    public partial struct double3x3 : System.IEquatable<double3x3>, IFormattable
    {
        ...
        /// <summary>Constructs a double3x3 matrix from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double3x3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double3x3(Single v)
        {
            this.c0 = v;
            this.c1 = v;
            this.c2 = v;
        ...
        /// <summary>Implicitly converts a single Single value to a double3x3 matrix by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double3x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double3x3(Single v) { return new double3x3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double3x3 matrix constructed from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double3x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3x3 double3x3(Single v) { return new double3x3(v); }
        ...
        public static double3x3 inverse(double3x3 m)
        {
            ...
            Double rcpDet = 1 / csum(t0.zxy * m0);
