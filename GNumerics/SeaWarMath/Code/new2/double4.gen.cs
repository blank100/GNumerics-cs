...
namespace SeaWar.Mathematics
{
    ...
    public partial struct double4 : System.IEquatable<double4>, IFormattable
    {
        ...
        /// <summary>Constructs a double4 vector from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double4(Single v)
        {
            this.x = v;
            this.y = v;
            this.z = v;
        ...
        /// <summary>Implicitly converts a single Single value to a double4 vector by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double4(Single v) { return new double4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double4 vector constructed from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4 double4(Single v) { return new double4(v); }
