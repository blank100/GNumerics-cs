...
namespace SeaWar.Mathematics
{
    ...
    public partial struct double4x4 : System.IEquatable<double4x4>, IFormattable
    {
        ...
        {
            this.c0 = math.select(new double4(0), new double4(1), v);
            this.c1 = math.select(new double4(0), new double4(1), v);
            this.c2 = math.select(new double4(0), new double4(1), v);
            this.c3 = math.select(new double4(0), new double4(1), v);
        }
        ...
        {
            this.c0 = math.select(new double4(0), new double4(1), v.c0);
            this.c1 = math.select(new double4(0), new double4(1), v.c1);
            this.c2 = math.select(new double4(0), new double4(1), v.c2);
            this.c3 = math.select(new double4(0), new double4(1), v.c3);
        }
        ...
        /// <summary>Constructs a double4x4 matrix from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double4x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double4x4(Single v)
        {
            this.c0 = v;
            this.c1 = v;
            this.c2 = v;
        ...
        /// <summary>Implicitly converts a single Single value to a double4x4 matrix by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double4x4(Single v) { return new double4x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double4x4 matrix constructed from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4x4 double4x4(Single v) { return new double4x4(v); }
        ...
        public static double4x4 inverse(double4x4 m)
        {
            ...
            double4 rcp_denom_ppnn = double4(1) / denom;
            double4x4 res;
