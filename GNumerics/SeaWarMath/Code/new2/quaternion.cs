...
namespace SeaWar.Mathematics
{
    ...
    public partial struct quaternion : System.IEquatable<quaternion>, IFormattable
    {
        ...
        /// <summary>Constructs a quaternion from four Single values.</summary>
        ...
        public quaternion(Single x, Single y, Single z, Single w) { value.x = x; value.y = y; value.z = z; value.w = w; }
        ...
        public quaternion(float3x3 m)
        {
            ...
            Single t = v.y + asfloat(asuint(w.z) ^ u_sign);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion AxisAngle(float3 axis, Single angle)
        {
            Single sina, cosa;
            math.sincos(Define.HalfOne * angle, out sina, out cosa);
        ...
        public static quaternion EulerXYZ(float3 xyz)
        {
            ...
            float3 s, c;
            sincos(Define.HalfOne * xyz, out s, out c);
            return quaternion(
                // s.x * c.y * c.z - s.y * s.z * c.x,
                // s.y * c.x * c.z + s.x * s.z * c.y,
                // s.z * c.x * c.y - s.x * s.y * c.z,
                // c.x * c.y * c.z + s.y * s.z * s.x
                float4(s.xyz, c.x) * c.yxxy * c.zzyz + s.yxxy * s.zzyz * float4(c.xyz, s.x) * float4(-1, 1, -1, 1)
                );
        }
        ...
        /// <returns>The quaternion representing the Euler angle rotation in x-y-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerXYZ(Single x, Single y, Single z) { return EulerXYZ(float3(x, y, z)); }
        ...
        /// <returns>The quaternion representing the Euler angle rotation in x-z-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerXZY(Single x, Single y, Single z) { return EulerXZY(float3(x, y, z)); }
        ...
        /// <returns>The quaternion representing the Euler angle rotation in y-x-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerYXZ(Single x, Single y, Single z) { return EulerYXZ(float3(x, y, z)); }
        ...
        /// <returns>The quaternion representing the Euler angle rotation in y-z-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerYZX(Single x, Single y, Single z) { return EulerYZX(float3(x, y, z)); }
        ...
        /// <returns>The quaternion representing the Euler angle rotation in z-x-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerZXY(Single x, Single y, Single z) { return EulerZXY(float3(x, y, z)); }
        ...
        /// <returns>The quaternion representing the Euler angle rotation in z-y-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerZYX(Single x, Single y, Single z) { return EulerZYX(float3(x, y, z)); }
        ...
        /// <returns>The quaternion representing the Euler angle rotation in the specified order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion Euler(Single x, Single y, Single z, math.RotationOrder order = math.RotationOrder.Default)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion RotateX(Single angle)
        {
            Single sina, cosa;
            math.sincos(Define.HalfOne * angle, out sina, out cosa);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion RotateY(Single angle)
        {
            Single sina, cosa;
            math.sincos(Define.HalfOne * angle, out sina, out cosa);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion RotateZ(Single angle)
        {
            Single sina, cosa;
            math.sincos(Define.HalfOne * angle, out sina, out cosa);
            return quaternion(0, 0, sina, cosa);
        }
    ...
    {
        /// <summary>Returns a quaternion constructed from four Single values.</summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion quaternion(Single x, Single y, Single z, Single w) { return new quaternion(x, y, z, w); }
       ...
       /// <returns>The conjugate of the input quaternion.</returns>
        ...
        {
            return quaternion(q.value * float4(-1, -1, -1, 1));
        }
       ...
       /// <returns>The quaternion inverse of the input quaternion.</returns>
        ...
        {
            float4 x = q.value;
            return quaternion(rcp(dot(x, x)) * x * float4(-1, -1, -1, 1));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single length(quaternion q)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single lengthsq(quaternion q)
        {
        ...
        {
            Single v_rcp_len = rsqrt(dot(q.value.xyz, q.value.xyz));
            Single v_len = rcp(v_rcp_len);
            Single sin_v_len, cos_v_len;
        ...
        {
            Single w = clamp(q.value.w, -1, 1);
            Single s = acos(w) * rsqrt(1 - w*w);
            return quaternion(float4(q.value.xyz * s, 0));
        }
        ...
        {
            Single v_len_sq = dot(q.value.xyz, q.value.xyz);
            Single q_len_sq = v_len_sq + q.value.w*q.value.w;

            Single s = acos(clamp(q.value.w * rsqrt(q_len_sq), -1, 1)) * rsqrt(v_len_sq);
            return quaternion(float4(q.value.xyz * s, Define.HalfOne * log(q_len_sq)));
        }
        ...
        {
            return quaternion(a.value.wwww * b.value + (a.value.xyzx * b.value.wwwx + a.value.yzxy * b.value.zxyy) * float4(1, 1, 1, -1) - a.value.zxyz * b.value.yzxz);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion nlerp(quaternion q1, quaternion q2, Single t)
        {
            Single dt = dot(q1, q2);
            if(dt < 0)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion slerp(quaternion q1, quaternion q2, Single t)
        {
            Single dt = dot(q1, q2);
            if (dt < 0)
            {
            ...
            if (dt < Define.Quaternion_SLerp_MaxValue)
            {
                Single angle = acos(dt);
                Single s = rsqrt(1 - dt * dt);    // 1 / sin(angle)
                Single w1 = sin(angle * (1 - t)) * s;
                Single w2 = sin(angle * t) * s;
