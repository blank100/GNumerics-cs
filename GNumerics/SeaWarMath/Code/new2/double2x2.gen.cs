...
namespace SeaWar.Mathematics
{
    ...
    public partial struct double2x2 : System.IEquatable<double2x2>, IFormattable
    {
        ...
        /// <summary>Constructs a double2x2 matrix from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double2x2(Single v)
        {
            this.c0 = v;
            this.c1 = v;
        }
        ...
        /// <summary>Implicitly converts a single Single value to a double2x2 matrix by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x2(Single v) { return new double2x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double2x2 matrix constructed from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x2 double2x2(Single v) { return new double2x2(v); }
        ...
        public static double2x2 inverse(double2x2 m)
        {
            ...
            return double2x2(d, -b, -c, a) * (1 / det);
        }
