...
namespace SeaWar.Mathematics
{
    ...
    public partial struct double2x3 : System.IEquatable<double2x3>, IFormattable
    {
        ...
        /// <summary>Constructs a double2x3 matrix from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2x3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double2x3(Single v)
        {
            this.c0 = v;
            this.c1 = v;
            this.c2 = v;
        ...
        /// <summary>Implicitly converts a single Single value to a double2x3 matrix by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x3(Single v) { return new double2x3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double2x3 matrix constructed from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(Single v) { return new double2x3(v); }
