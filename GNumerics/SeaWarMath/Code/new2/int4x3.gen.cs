...
namespace SeaWar.Mathematics
{
    ...
    public partial struct int4x3 : System.IEquatable<int4x3>, IFormattable
    {
        ...
        /// <summary>Constructs a int4x3 matrix from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int4x3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int4x3(Single v)
        {
            this.c0 = (int4)v;
            this.c1 = (int4)v;
            this.c2 = (int4)v;
        ...
        /// <summary>Explicitly converts a single Single value to a int4x3 matrix by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int4x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int4x3(Single v) { return new int4x3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int4x3 matrix constructed from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int4x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int4x3 int4x3(Single v) { return new int4x3(v); }
