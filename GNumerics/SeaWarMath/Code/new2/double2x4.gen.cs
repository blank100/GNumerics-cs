...
namespace SeaWar.Mathematics
{
    ...
    public partial struct double2x4 : System.IEquatable<double2x4>, IFormattable
    {
        ...
        {
            this.c0 = math.select(new double2(0), new double2(1), v);
            this.c1 = math.select(new double2(0), new double2(1), v);
            this.c2 = math.select(new double2(0), new double2(1), v);
            this.c3 = math.select(new double2(0), new double2(1), v);
        }
        ...
        {
            this.c0 = math.select(new double2(0), new double2(1), v.c0);
            this.c1 = math.select(new double2(0), new double2(1), v.c1);
            this.c2 = math.select(new double2(0), new double2(1), v.c2);
            this.c3 = math.select(new double2(0), new double2(1), v.c3);
        }
        ...
        /// <summary>Constructs a double2x4 matrix from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double2x4(Single v)
        {
            this.c0 = v;
            this.c1 = v;
            this.c2 = v;
        ...
        /// <summary>Implicitly converts a single Single value to a double2x4 matrix by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x4(Single v) { return new double2x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double2x4 matrix constructed from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x4 double2x4(Single v) { return new double2x4(v); }
