...
namespace SeaWar.Mathematics
{
    ...
    public partial struct half4 : System.IEquatable<half4>, IFormattable
    {
        ...
        /// <summary>Constructs a half4 vector from a single Single value by converting it to half and assigning it to every component.</summary>
        /// <param name="v">Single to convert to half4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public half4(Single v)
        {
            this.x = (half)v;
            this.y = (half)v;
            this.z = (half)v;
        ...
        /// <summary>Explicitly converts a single Single value to a half4 vector by converting it to half and assigning it to every component.</summary>
        /// <param name="v">Single to convert to half4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator half4(Single v) { return new half4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a half4 vector constructed from a single Single value by converting it to half and assigning it to every component.</summary>
        /// <param name="v">Single to convert to half4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static half4 half4(Single v) { return new half4(v); }
