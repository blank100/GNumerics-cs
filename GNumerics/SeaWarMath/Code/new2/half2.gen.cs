...
namespace SeaWar.Mathematics
{
    ...
    public partial struct half2 : System.IEquatable<half2>, IFormattable
    {
        ...
        /// <summary>Constructs a half2 vector from a single Single value by converting it to half and assigning it to every component.</summary>
        /// <param name="v">Single to convert to half2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public half2(Single v)
        {
            this.x = (half)v;
            this.y = (half)v;
        }
        ...
        /// <summary>Explicitly converts a single Single value to a half2 vector by converting it to half and assigning it to every component.</summary>
        /// <param name="v">Single to convert to half2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator half2(Single v) { return new half2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a half2 vector constructed from a single Single value by converting it to half and assigning it to every component.</summary>
        /// <param name="v">Single to convert to half2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static half2 half2(Single v) { return new half2(v); }
