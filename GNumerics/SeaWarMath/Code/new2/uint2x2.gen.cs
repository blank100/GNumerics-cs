...
namespace SeaWar.Mathematics
{
    ...
    public partial struct uint2x2 : System.IEquatable<uint2x2>, IFormattable
    {
        ...
        /// <summary>Constructs a uint2x2 matrix from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint2x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint2x2(Single v)
        {
            this.c0 = (uint2)v;
            this.c1 = (uint2)v;
        }
        ...
        /// <summary>Explicitly converts a single Single value to a uint2x2 matrix by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint2x2(Single v) { return new uint2x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint2x2 matrix constructed from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint2x2 uint2x2(Single v) { return new uint2x2(v); }
