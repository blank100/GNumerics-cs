...
namespace SeaWar.Mathematics
{
    ...
    public partial struct uint4x4 : System.IEquatable<uint4x4>, IFormattable
    {
        ...
        /// <summary>Constructs a uint4x4 matrix from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint4x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint4x4(Single v)
        {
            this.c0 = (uint4)v;
            this.c1 = (uint4)v;
            this.c2 = (uint4)v;
        ...
        /// <summary>Explicitly converts a single Single value to a uint4x4 matrix by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint4x4(Single v) { return new uint4x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint4x4 matrix constructed from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint4x4 uint4x4(Single v) { return new uint4x4(v); }
