...
namespace Gal.Core {
    ...
    public struct Complex {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vec2 operator *(Complex a, Vec2 b) => Rotate(a, b);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vec2 Rotate(Complex c, Vec2 v) =>
            new(
                c.r * v.x - c.i * v.y,
                c.r * v.y + c.i * v.x
            );
        ...
        // 逆旋转向量
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vec2 InverseRotate(in Complex c, in Vec2 v) =>
            new(
                c.r * v.x + c.i * v.y,
                -c.i * v.x + c.r * v.y
            );
