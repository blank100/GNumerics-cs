...
namespace Unity.Mathematics
{
    ...
    public partial struct uint2 : System.IEquatable<uint2>, IFormattable
    {
        ...
        /// <summary>Constructs a uint2 vector from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint2(Single v)
        {
            this.x = (uint)v;
            this.y = (uint)v;
        }
        ...
        /// <summary>Explicitly converts a single Single value to a uint2 vector by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint2(Single v) { return new uint2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint2 vector constructed from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint2 uint2(Single v) { return new uint2(v); }
