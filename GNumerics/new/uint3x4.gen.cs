...
namespace Unity.Mathematics
{
    ...
    public partial struct uint3x4 : System.IEquatable<uint3x4>, IFormattable
    {
        ...
        /// <summary>Constructs a uint3x4 matrix from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint3x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint3x4(Single v)
        {
            this.c0 = (uint3)v;
            this.c1 = (uint3)v;
            this.c2 = (uint3)v;
        ...
        /// <summary>Explicitly converts a single Single value to a uint3x4 matrix by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3x4(Single v) { return new uint3x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint3x4 matrix constructed from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint3x4 uint3x4(Single v) { return new uint3x4(v); }
