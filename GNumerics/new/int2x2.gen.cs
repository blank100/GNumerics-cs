...
namespace Unity.Mathematics
{
    ...
    public partial struct int2x2 : System.IEquatable<int2x2>, IFormattable
    {
        ...
        /// <summary>Constructs a int2x2 matrix from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int2x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int2x2(Single v)
        {
            this.c0 = (int2)v;
            this.c1 = (int2)v;
        }
        ...
        /// <summary>Explicitly converts a single Single value to a int2x2 matrix by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int2x2(Single v) { return new int2x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int2x2 matrix constructed from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2x2 int2x2(Single v) { return new int2x2(v); }
