...
namespace Unity.Mathematics
{
    ...
    public partial struct uint3 : System.IEquatable<uint3>, IFormattable
    {
        ...
        /// <summary>Constructs a uint3 vector from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint3(Single v)
        {
            this.x = (uint)v;
            this.y = (uint)v;
            this.z = (uint)v;
        ...
        /// <summary>Explicitly converts a single Single value to a uint3 vector by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3(Single v) { return new uint3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint3 vector constructed from a single Single value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">Single to convert to uint3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint3 uint3(Single v) { return new uint3(v); }
