...
namespace Unity.Mathematics
{
    ...
    public partial struct int2 : System.IEquatable<int2>, IFormattable
    {
        ...
        /// <summary>Constructs a int2 vector from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int2(Single v)
        {
            this.x = (int)v;
            this.y = (int)v;
        }
        ...
        /// <summary>Explicitly converts a single Single value to a int2 vector by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int2(Single v) { return new int2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int2 vector constructed from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2 int2(Single v) { return new int2(v); }
