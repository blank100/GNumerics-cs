...
namespace Unity.Mathematics
{
    ...
    public partial struct float3x3
    {
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in the given order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 Euler(Single x, Single y, Single z, RotationOrder order = RotationOrder.Default)
        {
    ...
    public partial struct float4x4
    {
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in given order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 Euler(Single x, Single y, Single z, RotationOrder order = RotationOrder.Default)
        {
            return Euler(float3(x, y, z), order);
        }
        ...
        {
            Single cotangent = 1 / tan(verticalFov * 0.5f);
