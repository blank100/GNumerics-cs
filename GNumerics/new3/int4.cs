...
namespace SeaWar.Mathematics
{
    ...
    public partial struct int4 : System.IEquatable<int4>, IFormattable
    {
        ...
        /// <summary>Constructs a int4 vector from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int4(Single v)
        {
            this.x = (int)v;
            this.y = (int)v;
            this.z = (int)v;
        ...
        /// <summary>Explicitly converts a single Single value to a int4 vector by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int4(Single v) { return new int4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int4 vector constructed from a single Single value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">Single to convert to int4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int4 int4(Single v) { return new int4(v); }
