...
namespace SeaWar.Mathematics
{
    ...
    public struct RigidTransform
    {
        ...
        public static readonly RigidTransform identity = new RigidTransform(new quaternion(0, 0, 0, 1), new float3(0, 0, 0));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform AxisAngle(float3 axis, Single angle) { return new RigidTransform(quaternion.AxisAngle(axis, angle), float3.zero); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in x-y-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerXYZ(Single x, Single y, Single z) { return EulerXYZ(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in x-z-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerXZY(Single x, Single y, Single z) { return EulerXZY(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in y-x-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerYXZ(Single x, Single y, Single z) { return EulerYXZ(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in y-z-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerYZX(Single x, Single y, Single z) { return EulerYZX(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in z-x-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerZXY(Single x, Single y, Single z) { return EulerZXY(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in z-y-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerZYX(Single x, Single y, Single z) { return EulerZYX(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in the given rotation order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform Euler(Single x, Single y, Single z, math.RotationOrder order = math.RotationOrder.Default)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform RotateX(Single angle)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform RotateY(Single angle)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform RotateZ(Single angle)
        {
