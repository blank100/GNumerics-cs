...
namespace SeaWar.Mathematics
{
    ...
    public partial struct double3 : System.IEquatable<double3>, IFormattable
    {
        ...
        /// <summary>Constructs a double3 vector from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double3(Single v)
        {
            this.x = v;
            this.y = v;
            this.z = v;
        ...
        /// <summary>Implicitly converts a single Single value to a double3 vector by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double3(Single v) { return new double3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double3 vector constructed from a single Single value by converting it to Double and assigning it to every component.</summary>
        /// <param name="v">Single to convert to double3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3 double3(Single v) { return new double3(v); }
