...
namespace SeaWar.Mathematics
{
    public partial struct float2x2
    {
        ...
        public static float2x2 Rotate(Single angle)
        {
            Single s, c;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2x2 Scale(Single s)
        {
            return float2x2(s,    0,
                            0, s);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2x2 Scale(Single x, Single y)
        {
            return float2x2(x,    0,
                            0, y);
        }
    ...
    public partial struct float3x3
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 AxisAngle(float3 axis, Single angle)
        {
            Single sina, cosa;
            ...
            float3 u_yzx = u.yzx;
            float3 u_zxy = u.zxy;
            float3 u_inv_cosa = u - u * cosa;  // u * (1 - cosa);
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in x-y-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerXYZ(Single x, Single y, Single z) { return EulerXYZ(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in x-z-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerXZY(Single x, Single y, Single z) { return EulerXZY(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in y-x-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerYXZ(Single x, Single y, Single z) { return EulerYXZ(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in y-z-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerYZX(Single x, Single y, Single z) { return EulerYZX(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in z-x-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerZXY(Single x, Single y, Single z) { return EulerZXY(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in z-y-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerZYX(Single x, Single y, Single z) { return EulerZYX(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in the given order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 Euler(Single x, Single y, Single z, math.RotationOrder order = math.RotationOrder.Default)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 RotateX(Single angle)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 RotateY(Single angle)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 RotateZ(Single angle)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 Scale(Single s)
        {
            return float3x3(s,    0, 0,
                            0, s,    0,
                            0, 0, s);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 Scale(Single x, Single y, Single z)
        {
        ...
        {
            Single forwardLengthSq = dot(forward, forward);
            Single upLengthSq = dot(up, up);

            forward *= rsqrt(forwardLengthSq);
            up *= rsqrt(upLengthSq);

            float3 t = cross(up, forward);
            Single tLengthSq = dot(t, t);
            t *= rsqrt(tLengthSq);
    ...
    public partial struct float4x4
    {
        ...
        {
            c0 = float4(rotation.c0, 0);
            c1 = float4(rotation.c1, 0);
            c2 = float4(rotation.c2, 0);
            c3 = float4(translation, 1);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 AxisAngle(float3 axis, Single angle)
        {
            Single sina, cosa;
            math.sincos(angle, out sina, out cosa);

            float4 u = float4(axis, 0);
            float4 u_yzx = u.yzxx;
            float4 u_zxy = u.zxyx;
            float4 u_inv_cosa = u - u * cosa;  // u * (1 - cosa);
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in x-y-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerXYZ(Single x, Single y, Single z) { return EulerXYZ(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in x-z-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerXZY(Single x, Single y, Single z) { return EulerXZY(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in y-x-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerYXZ(Single x, Single y, Single z) { return EulerYXZ(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in y-z-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerYZX(Single x, Single y, Single z) { return EulerYZX(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in z-x-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerZXY(Single x, Single y, Single z) { return EulerZXY(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in z-y-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerZYX(Single x, Single y, Single z) { return EulerZYX(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in given order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 Euler(Single x, Single y, Single z, math.RotationOrder order = math.RotationOrder.Default)
        {
            return Euler(float3(x, y, z), order);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 RotateX(Single angle)
        {
            // {{1, 0, 0}, {0, c_0, -s_0}, {0, s_0, c_0}}
            Single s, c;
            sincos(angle, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 RotateY(Single angle)
        {
            // {{c_1, 0, s_1}, {0, 1, 0}, {-s_1, 0, c_1}}
            Single s, c;
            sincos(angle, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 RotateZ(Single angle)
        {
            // {{c_2, -s_2, 0}, {s_2, c_2, 0}, {0, 0, 1}}
            Single s, c;
            sincos(angle, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 Scale(Single s)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 Scale(Single x, Single y, Single z)
        {
        ...
        public static float4x4 LookAt(float3 eye, float3 target, float3 up)
        {
            ...
            float4x4 matrix;
            matrix.c0 = float4(rot.c0, 0);
            matrix.c1 = float4(rot.c1, 0);
            matrix.c2 = float4(rot.c2, 0);
            matrix.c3 = float4(eye, 1);
            return matrix;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 Ortho(Single width, Single height, Single near, Single far)
        {
            Single rcpdx = 1 / width;
            Single rcpdy = 1 / height;
            Single rcpdz = 1 / (far - near);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 OrthoOffCenter(Single left, Single right, Single bottom, Single top, Single near, Single far)
        {
            Single rcpdx = 1 / (right - left);
            Single rcpdy = 1 / (top - bottom);
            Single rcpdz = 1 / (far - near);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 PerspectiveFov(Single verticalFov, Single aspect, Single near, Single far)
        {
            Single cotangent = 1 / tan(verticalFov * Define.HalfOne);
            Single rcpdz = 1 / (near - far);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 PerspectiveOffCenter(Single left, Single right, Single bottom, Single top, Single near, Single far)
        {
            Single rcpdz = 1 / (near - far);
            Single rcpWidth = 1 / (right - left);
            Single rcpHeight = 1 / (top - bottom);
        ...
        public static float4x4 TRS(float3 translation, quaternion rotation, float3 scale)
        {
            ...
            return float4x4(  float4(r.c0 * scale.x, 0),
                              float4(r.c1 * scale.y, 0),
                              float4(r.c2 * scale.z, 0),
    ...
    partial class math
    {
        ...
        public static float3x3 orthonormalize(float3x3 i)
        {
            ...
            Single lenU = math.length(u);
            Single lenV = math.length(v);

            bool c = lenU > Define.SafeMinValue && lenV > Define.SafeMinValue;
