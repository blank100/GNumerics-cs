...
namespace SeaWar.Mathematics
{
    ...
    public partial struct Random
    {
        ...
        /// <summary>Returns a uniformly random Single value in the interval [0, 1).</summary>
        /// <returns>A uniformly random Single value in the range [0, 1).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Single NextFloat()
        {
            return asfloat(0x3f800000 | (NextState() >> 9)) - 1;
        }
        ...
        {
            return asfloat(0x3f800000 | (uint2(NextState(), NextState()) >> 9)) - 1;
        }
        ...
        {
            return asfloat(0x3f800000 | (uint3(NextState(), NextState(), NextState()) >> 9)) - 1;
        }
        ...
        {
            return asfloat(0x3f800000 | (uint4(NextState(), NextState(), NextState(), NextState()) >> 9)) - 1;
        }


        /// <summary>Returns a uniformly random Single value in the interval [0, max).</summary>
        /// <param name="max">The maximum value to generate, exclusive.</param>
        /// <returns>A uniformly random Single value in the range [0, max).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Single NextFloat(Single max) { return NextFloat() * max; }
        ...
        /// <summary>Returns a uniformly random Single value in the interval [min, max).</summary>
        /// <param name="min">The minimum value to generate, inclusive.</param>
        /// <param name="max">The maximum value to generate, exclusive.</param>
        /// <returns>A uniformly random Single value in the range [min, max).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Single NextFloat(Single min, Single max) { return NextFloat() * (max - min) + min; }
        ...
        public Double NextDouble()
        {
            ...
            return asdouble(0x3ff0000000000000 | sx) - 1;
        }
        ...
        public double2 NextDouble2()
        {
            ...
            return double2(asdouble(0x3ff0000000000000 | sx),
                           asdouble(0x3ff0000000000000 | sy)) - 1;
        }
        ...
        public double3 NextDouble3()
        {
            ...
            return double3(asdouble(0x3ff0000000000000 | sx),
                           ...
                           asdouble(0x3ff0000000000000 | sz)) - 1;
        }
        ...
        public double4 NextDouble4()
        {
            ...
            return double4(asdouble(0x3ff0000000000000 | sx),
                           ...
                           asdouble(0x3ff0000000000000 | sw)) - 1;
        }
        ...
        public float3 NextFloat3Direction()
        {
            ...
            Single z = rnd.x * 2 - 1;
            Single r = sqrt(max(1 - z * z, 0));
            Single angle = rnd.y * PI * 2;
            Single s, c;
            sincos(angle, out s, out c);
        ...
        public double3 NextDouble3Direction()
        {
            ...
            Double z = rnd.x * 2 - 1;
            Double r = sqrt(max(1 - z * z, 0));
            Double angle = rnd.y * PI_DBL * 2;
            Double s, c;
            sincos(angle, out s, out c);
        ...
        {
            float3 rnd = NextFloat3(float3(2 * PI, 2 * PI, 1));
            Single u1 = rnd.z;
            ...
            return quaternion(select(q.value, -q.value, q.value.w < 0));
        }
